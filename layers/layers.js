...
var format_New_ULBs_7 = new ol.format.GeoJSON();
var features_New_ULBs_7 = format_New_ULBs_7.readFeatures(json_New_ULBs_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_New_ULBs_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_New_ULBs_7.addFeatures(features_New_ULBs_7);
var lyr_New_ULBs_7 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_New_ULBs_7, 
                style: style_New_ULBs_7,
                popuplayertitle: 'New_ULBs',
                interactive: true,
                title: '<img src="styles/legend/New_ULBs_7.png" /> New_ULBs'
            });
...
lyr_GoogleHybrid_0.setVisible(true);lyr_OSMStandard_1.setVisible(true);lyr_TelanganaState_2.setVisible(true);lyr_ExclusionofGPs_3.setVisible(true);lyr_UpgradationGreaterCorporation_4.setVisible(true);lyr_UpgradationMunicipalCorporation_5.setVisible(true);lyr_InclusionofGPs_6.setVisible(true);lyr_New_ULBs_7.setVisible(true);lyr_ExistingULBBoundary_8.setVisible(true);lyr_ExistingULBs_9.setVisible(true);lyr_ImageAttachment_10.setVisible(true);
var layersList = [lyr_GoogleHybrid_0,lyr_OSMStandard_1,lyr_TelanganaState_2,lyr_ExclusionofGPs_3,lyr_UpgradationGreaterCorporation_4,lyr_UpgradationMunicipalCorporation_5,lyr_InclusionofGPs_6,lyr_New_ULBs_7,group_ExistingULBs];
...
lyr_New_ULBs_7.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'Name': 'Name of ULBs', 'Area': 'Area(SQ.KM)', 'No_Vill': 'No of Villages', 'Name_Vill': 'Name of Villages', 'Population': 'Population(2024)', 'Pop_Den': 'Population Density(P/SQ.KM)', 'Img_Link': 'Img_Link', });
...
lyr_New_ULBs_7.set('fieldImages', {'OBJECTID': 'TextEdit', 'Name': 'TextEdit', 'Area': 'TextEdit', 'No_Vill': 'Range', 'Name_Vill': 'TextEdit', 'Population': 'Range', 'Pop_Den': 'Range', 'Img_Link': '', });
...
lyr_New_ULBs_7.set('fieldLabels', {'OBJECTID': 'hidden field', 'Name': 'inline label - visible with data', 'Area': 'inline label - visible with data', 'No_Vill': 'inline label - visible with data', 'Name_Vill': 'inline label - visible with data', 'Population': 'inline label - visible with data', 'Pop_Den': 'inline label - visible with data', 'Img_Link': 'hidden field', });
